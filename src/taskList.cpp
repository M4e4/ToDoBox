...
// void TaskList::setSelectedStyle(QListWidgetItem* item, bool selected)
// {
//     if(!item) return;
...
// void TaskList::filter(QString text, Status status)
// {
//     for (int i{}; i < count(); ++i)
//     {
...
// QIcon TaskList::getIcon(Status status)
// {
